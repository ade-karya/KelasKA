/**
 * The KelasKA slide object model — the canonical, dependency-free contract.
 *
 * This file is the single source of truth that supersedes the three copies that
 * had drifted apart before @kelaska/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@kelaska/renderer/src/types/slides.ts
 *   - importer: packages/@kelaska/importer/src/kelaska/types/slides.ts
 *
