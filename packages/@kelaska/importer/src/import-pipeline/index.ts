/**
 * High-level entry: parsed pptxtojson(-pro) JSON → KelasKA canvas `Slide[]`.
 *
 ...
 * whole import either.
 */
import type { Slide } from '@kelaska/dsl';
...
/**
 * Convert a pre-parsed pptxtojson(-pro) `Output` JSON into KelasKA slides.
 *
...
/**
 * Parse a .pptx file and convert it into KelasKA canvas slides.
 *
