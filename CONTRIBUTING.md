...
| **New feature or architecture change** | Start a [GitHub Discussion](/discussions) or ask in [Discord](https://discord.gg/p8Pf2r3SaG) **before** opening a PR |
...
Use the [Feature Request](/issues/new?template=feature_request.yml) issue template. For larger features, please open a [Discussion](/discussions) first.
