...
- **Discussion TTS** — Voice playback during discussion phase with per-agent voice assignment, supporting all TTS providers including browser-native [#211](https://github.com/ade-karya/KelasKA/pull/211)
- **Immersive Mode** — Full-screen view with speech bubbles, auto-hide controls, and keyboard navigation [#195](https://github.com/ade-karya/KelasKA/pull/195) (by @YizukiAme)
- **Discussion buffer-level pause** — Freeze text reveal without aborting the AI stream [#129](https://github.com/ade-karya/KelasKA/pull/129) (by @YizukiAme)
- **Keyboard shortcuts** — Comprehensive roundtable controls: T/V/Esc/Space/M/S/C [#256](https://github.com/ade-karya/KelasKA/pull/256) (by @YizukiAme)
- **Whiteboard enhancements** — Pan, zoom, auto-fit [#31](https://github.com/ade-karya/KelasKA/pull/31), history and auto-save [#40](https://github.com/ade-karya/KelasKA/pull/40) (by @YizukiAme)
- **New providers** — ElevenLabs TTS [#134](https://github.com/ade-karya/KelasKA/pull/134) (by @nkmohit), Grok/xAI for LLM, image, and video [#113](https://github.com/ade-karya/KelasKA/pull/113) (by @KanameMadoka520)
- **Server-side generation** — Media and TTS generation on the server [#75](https://github.com/ade-karya/KelasKA/pull/75) (by @cosarah)
- **1.25x playback speed** [#131](https://github.com/ade-karya/KelasKA/pull/131) (by @YizukiAme)
- **OpenClaw integration** — Generate classrooms from Feishu, Slack, Telegram, and 20+ messaging apps [#4](https://github.com/ade-karya/KelasKA/pull/4) (by @cosarah)
- **Vercel one-click deploy** [#2](https://github.com/ade-karya/KelasKA/pull/2) (by @cosarah)

### Security

- Fix SSRF and credential forwarding via client-supplied baseUrl [#30](https://github.com/ade-karya/KelasKA/pull/30) (by @Wing900)
- Use resolved API key in chat route instead of client-sent key [#221](https://github.com/ade-karya/KelasKA/pull/221)

### Testing

- Add Vitest unit testing infrastructure [#144](https://github.com/ade-karya/KelasKA/pull/144)
- Add Playwright e2e testing framework [#229](https://github.com/ade-karya/KelasKA/pull/229)
