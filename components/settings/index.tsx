...
const IMAGE_PROVIDER_NAMES: Record<ImageProviderId, string> = {
  ...
  imagen: 'providerImagen',
  pollinations: 'providerPollinations',
};
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="h-[85vh] p-0 gap-0 block" showCloseButton={false}>
        ...
        <div className="flex h-full overflow-hidden">
          ...
          <div className="flex-shrink-0 bg-muted/30 p-3 space-y-1 overflow-y-auto" style={{ width: sidebarWidth }}>
            <button
